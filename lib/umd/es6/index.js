      ...
      for (const dep of resolvedDeps) {
        if (!('finalVALUE' in dep)) {
          ...
          try {
            ...
            dep.finalVALUE = /javascript/i.test(dep.type) ? (await initializeJavascriptModule(dep.finalUrl, preProcessed)).module : preProcessed; // NOW, can assign to global (if need be)
            ...
            dep.globalName && (window[globalName] = dep.finalVALUE); // housekeeping: delete all keys now that we have a final value
