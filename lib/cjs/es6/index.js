...
}, // UNPKG: see README.md#cdn-issues
{
  ...
  r: (u, b) => `https://unpkg.com/${repl(u, /^unpkg[@#]/i, '')}`
}, // see README.md#cdn-issues
      ...
      if (typeof dep === 'string') {
        ...
        if (url) {
          ...
          if (inProgress) {
            ...
            // freeze ("close") finalUrl for this download...
            ...
            downloads.push(alreadyInProgress[requestUrl] = (0, _tidbits.http)(requestUrl).then(downloaded => {
              ...
              } else log('URLx-200 - not redirected', actualUrl);
